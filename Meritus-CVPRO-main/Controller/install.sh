...
main() {
    ...
    echo -e "Do you have a valid Internet Connection? - '${BLUE}y${NC}' or '${BLUE}n${NC}': " 
    read userInput
    if [[ "$userInput" == "y" ]]; then
        echo -e "${BLUE}Installing dependencies...................${NC}"

        cd "$userProfile/Meritus-CVPRO-Linux/Meritus-CVPRO-main/Controller"
        ...
        cd "$userProfile/Meritus-CVPRO-Linux/Meritus-CVPRO-main/Environment_Setup"
        ...
        if [ $? -ne 0 ]; then
            ...
            echo ""
            echo -e "${BLUE}Check for the following:${NC}"
            echo ""
            ...
            echo ""
            echo -e "${GREEN}Installation is Completed!${NC}"
            echo ""
        ...
        echo -e "${BLUE}Please do have a valid Internet Connection for the Installation Process.${NC}"
    else
